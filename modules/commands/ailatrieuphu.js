...
module.exports.config = {
  ...
  usages: "register/play/info/stop,lệnh đây không bạn /altp sẽ có hưỡng dẫn cụ thể",
...
function equi(level) {
  ...
  if (level == 1) var tienthuong = 20;

  if (level == 2) var tienthuong = 40;

  if (level == 3) var tienthuong = 60;

  if (level == 4) var tienthuong = 100;

  if (level == 5) var tienthuong = 200;

  if (level == 6) var tienthuong = 300;

  if (level == 7) var tienthuong = 600;

  if (level == 8) var tienthuong = 1000;

  if (level == 9) var tienthuong = 1400;

  if (level == 10) var tienthuong = 2200;

  if (level == 11) var tienthuong = 3000;

  if (level == 12) var tienthuong = 4000;

  if (level == 13) var tienthuong = 8000;

  if (level == 14) var tienthuong = 15000;
