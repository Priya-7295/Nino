...
module.exports.config = {
  ...
  hasPermission: 0,
  credits: "Lemon",
  description: "Lấy thông tin chi tiết về vi phạm giao thông qua biển số xe",
  commandCategory: "Thành Viên",
  usages: "bienso + biển số xe ô tô [ví dụ bienso 51G69353]",
  cooldowns: 5,
};
...
module.exports.run = async function({ api, event, args }) {
  ...
  const apiUrl = `https://api.sumiproject.net/checkpn?bienso=${licensePlate}`;
  try {
