...
module.exports.run = async function({
   ...
   const link = [
"https://i.imgur.com/kzl3Ejm.gif",
"https://i.imgur.com/VHxDNyZ.gif",
"https://i.imgur.com/JXvDmuL.gif",
"https://i.imgur.com/G3CuyJd.gif"
   ];
  var random_link = link[Math.floor(Math.random() * link.length)]
   ...
   // if (type == "all") return
    if (type) {
        ...
        api.sendMessage({body: msg,attachment: await url(random_link)},tid, mid)
    } else {
        CmdCategory()
        ...
        api.sendMessage({body: msg, attachment: await url(random_link)}, tid)
    }
