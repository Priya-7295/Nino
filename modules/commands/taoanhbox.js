...
module.exports.circle = async (image) => {
  ...
  /*============DOWNLOAD FONTS=============*/
  if(!fs.existsSync(__dirname+`/tad/TUVBenchmark.ttf`)) { 
      ...
      fs.writeFileSync(__dirname+`/tad/TUVBenchmark.ttf`, Buffer.from(downFonts, "utf-8"));
    };
  /*===========BACKGROUND & AVATAR FRAMES==========*/
  var bg = ['https://i.imgur.com/P3QrAgh.jpg',
  ...
  /*=================DRAW AVATAR MEMBERS==============*/
    ...
    /*==================DRAW TITLE==================*/
    Canvas.registerFont(__dirname+`/tad/TUVBenchmark.ttf`, { family: "TUVBenchmark"});
