...
const key = "AIzaSyCgo-FEzl-Ku5o43mZp2zc5dOPZaMyb1A0";
...
module.exports.run = async function ({ api, event, args }) {
    ...
    const getBasicInfo = async (keyword) => {
        try {
            const mediaData = (await axios.get(encodeURI(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=12&q=${keyword}&type=video&key=${key}`))).data.items;
            return mediaData;
        } catch (e) {
            throw e;
        }
